...
public class MovieService {
	...
	public static class MovieRowMapper implements RowMapper<Movie> {
		 ...
		 */
		public static final String SELECT_ALL = "SELECT * FROM game LEFT JOIN creator dir ON game.gameId = dir.id";
		...
		public Movie mapRow(ResultSet rs, int rowNum) throws SQLException {
			...
			movie.setImbdLink(rs.getString("wikilink"));
			

			final Director director = new Director();
			director.setId(rs.getLong("gameId"));
